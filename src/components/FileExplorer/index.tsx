...
export default function FileExplorer({
	...
	const [_dragOverCounter, setDragOverCounter] = useState(0)
	...
	return (
		<div className="relative h-full flex flex-col w-full bg-gray-900 border-r border-gray-700">
			<FileExplorerHeader project={project} onToggleCollapse={onToggleCollapse || (() => {})} onRenameProject={onRenameProject || (() => {})} />
				...
				{isDraggingExternal && (
					<div className="absolute inset-0 flex items-center justify-center bg-gray-900/80 pointer-events-none z-10">
						<div className="text-center">
							...
							<p className="text-blue-300 font-medium">拖放文件以上传</p>
