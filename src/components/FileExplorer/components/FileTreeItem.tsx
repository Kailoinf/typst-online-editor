			...
			<div className="px-4 py-2 bg-gray-800" style={{ paddingLeft: `${depth * 12 + 16}px` }}>
				<div className="flex items-center gap-2">
					...
					<input
						...
						autoFocus
					/>
					<button onClick={onRename} className="p-1 hover:bg-gray-700 rounded" title="重命名">
						<Check className="w-3 h-3 text-green-400" />
					</button>
					<button onClick={onCancelRename} className="p-1 hover:bg-gray-700 rounded" title="取消">
